...
export default function MyPapers() {
    ...
    const SortIcon = ({ field }: { field: SortField }) => {
        if (sortField !== field)
            return <ArrowUpDown className="w-3 h-3 ml-1 text-stone-400" />;
        return sortDir === "asc" ? (
            ...
            <div className="max-w-6xl mx-auto p-6 md:p-8 space-y-6">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-stone-900">
                        Riwayat Analisis Paper
                    </h1>
                    <p className="text-sm text-stone-500 mt-1">
                        Daftar semua paper yang pernah Anda unggah dan analisis
                        dengan AI.
                    </p>
                </div>
                    ...
                    {loading ? (
                        ...
                        <div className="p-16 text-center text-stone-500 flex flex-col items-center">
                            ...
                            <p className="font-medium">
                                Anda belum mengunggah paper apa pun.
                            </p>
                            <Link
                                href="/upload"
                                className="mt-4 inline-flex items-center space-x-1.5 px-4 py-2 bg-stone-900 text-white text-sm font-semibold rounded-xl hover:bg-stone-800 transition shadow-sm"
                            >
                        ...
                        <div className="p-12 text-center text-stone-400 flex flex-col items-center">
                            ...
                            <p className="font-medium text-stone-500">
                                Tidak ada paper yang cocok dengan pencarian.
                            </p>
                            <button
                                onClick={() => {
                                    setSearch("");
                                ...
                                className="mt-3 text-rose-600 hover:text-rose-800 text-sm font-semibold"
                            >
                                Reset Filter
                            </button>
                        </div>
                                    ...
                                    <tr>
                                        <th className="px-6 py-4 font-semibold border-b border-[#e8e4dc] w-[38%]">
                                            <button
                                                ...
                                                className="flex items-center font-semibold hover:text-stone-900 transition"
                                            >
                                                Judul Paper{" "}
                                        ...
                                        <th className="px-6 py-4 font-semibold border-b border-[#e8e4dc] w-[12%] text-right">
                                            Aksi
                                        </th>
                                    </tr>
                                </thead>
                                        ...
                                        return (
                                            ...
                                            >
                                                <td className="px-6 py-4">
                                                    <p
                                                        className="font-semibold text-stone-900 group-hover:text-rose-700 transition-colors"
                                                        title={p.title}
                                                    >
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex flex-col items-start gap-1">
                                                        <span
                                                            className={`inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold border ${statusCfg.classes}`}
                                                        >
                                                            {statusCfg.label}
                                                        </span>
                                                        {p.submission_status ===
